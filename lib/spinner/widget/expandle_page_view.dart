...
import 'package:indtubes_1/spinner/widget/size_reporting_widget.dart';
...
class ExpandablePageView extends StatefulWidget {
  ...
  /// [ExpandablePageView] size animation. This can lead to a
  ...
  //
  // Defaults to null, wherein the inherited ScrollBehavior is copied and modified to alter the viewport decoration, like .
  //
...
class _ExpandablePageViewState extends State<ExpandablePageView> {
  ...
  double get currentSize => _sizes[_currentPage];

  double get previousSize => _sizes[_previousPage];
  ...
  Widget build(BuildContext context) {
    return TweenAnimationBuilder<double>(
      ...
      tween: Tween<double>(begin: previousSize, end: currentSize),
